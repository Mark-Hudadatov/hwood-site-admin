 ...
 * Atomic components and style objects used across the public site.
 * All values use design tokens — no raw hex literals.
 */
...
export const StatusDot: React.FC<{ color?: string }> = ({ color = COLORS.accentMint }) => (
  <span
    style={{
      display: 'inline-block',
      width: 8,
