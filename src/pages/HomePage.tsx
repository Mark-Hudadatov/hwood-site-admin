    ...
    <>
      ...
      <section id="services" className="bg-[#f8f8f8] py-16 md:py-24 xl:py-32 px-6 md:px-12 lg:px-20 xl:px-32 2xl:px-40 overflow-hidden select-none">
        ...
        <div 
          ...
          className="scroll-x-bleed flex gap-5 md:gap-6 lg:gap-8 pb-12 cursor-grab active:cursor-grabbing"
      ...
      <div className="relative w-full overflow-hidden" style={{ backgroundColor: settings.layout.background_dark }}>
        ...
        <section className="relative z-10 w-full text-white py-12 md:py-20 xl:py-24 px-6 md:px-12 lg:px-20 xl:px-32 2xl:px-40">
          ...
          <div ref={storiesScrollRef} className="scroll-x-bleed flex pb-10 scroll-smooth snap-x snap-mandatory gap-5 md:gap-6 lg:gap-8 xl:gap-10">
            {stories.map((story) => (
