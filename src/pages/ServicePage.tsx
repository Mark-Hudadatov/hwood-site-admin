    ...
    const loadData = async () => {
      ...
      if (serviceData) {
        setService({
          ...
          subtitle: lang === 'he' && serviceData.subtitle_he ? serviceData.subtitle_he : serviceData.subtitle_en || '',
          description: lang === 'he' && serviceData.description_he ? serviceData.description_he : serviceData.description_en || '',
          ctaText: lang === 'he' && serviceData.cta_text_he ? serviceData.cta_text_he : serviceData.cta_text_en || '',
