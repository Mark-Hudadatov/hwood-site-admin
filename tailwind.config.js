  ...
  theme: {
    extend: {
      colors: {
        ...
        // Order-type surfaces (static, safe for Tailwind)
        surface: {
          dark:     '#002828',
          black:    '#0a0a0a',
          charcoal: '#1a1a1a',
      ...
      keyframes: {
        'slow-zoom':  { from: { transform: 'scale(1.05)' }, to: { transform: 'scale(1.15)' } },
        'fade-in':    { from: { opacity: '0' }, to: { opacity: '1' } },
        'fade-in-up': { from: { opacity: '0', transform: 'translateY(24px)' }, to: { opacity: '1', transform: 'translateY(0)' } },
        'pulse-glow': { '0%,100%': { boxShadow: '0 0 0 0 rgba(0,95,95,.4)' }, '50%': { boxShadow: '0 0 0 10px rgba(0,95,95,0)' } },
        'check-pop':  { '0%': { transform: 'scale(.5)', opacity: '0' }, '60%': { transform: 'scale(1.12)' }, '100%': { transform: 'scale(1)', opacity: '1' } },
